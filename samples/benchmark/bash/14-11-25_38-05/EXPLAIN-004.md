...
- Generated at: 2025-11-11T19:27:50.214Z
...
- File: `execute_cmd.c` (line 624)
- Signature: `execute_command_internal (COMMAND *command, int asynchronous, int pipe_in, int pipe_out, struct fd_bitmap *fds_to_close)`
- Body length: 610 line(s)
- Highlights:
  - Delegates complex dispatch to `execute_command_internal()`.
