...
1) Core loop hardening
   ...
   - Stop-reason persistence closeout (2026-02-10):
     ...
     - Regression coverage added: `unit-tests-js/miniphi-memory-stop-reason.test.js`, `unit-tests-js/task-execution-register-stop-reason.test.js`, `unit-tests-js/cli-implicit-run.test.js` plus updates to `unit-tests-js/lmstudio-error-utils.test.js`, `unit-tests-js/prompt-recorder.test.js`, and `unit-tests-js/prompt-step-journal.test.js`; `npm test` passed (`63/63`).
