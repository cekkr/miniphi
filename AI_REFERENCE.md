...
## Next Steps
1. Extend `benchmark/scripts/bash-flow-explain.js` so its EXPLAIN files mirror the manual narrative (call flow, trap behavior, future work) instead of only listing direct callees.
