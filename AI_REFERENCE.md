...
- Recompose benchmark runs now emit timestamped artifacts under `samples/benchmark/recompose/<dd-mm-yy_mm-hh>/RUN-###.{json,log}` so different parameter sweeps stay organized next to WHY_SAMPLES guidance.
